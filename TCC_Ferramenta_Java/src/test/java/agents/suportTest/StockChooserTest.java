...
import core.agents.suport.StockChooser;
...
public class StockChooserTest {
	...
	/*
	 * qtdPositiveCorrel=0 sem correlacao qtdPositiveCorrel=1 Uma correlacao
	 * positiva qtdPositiveCorrel=2 Duas correlacao positivas
