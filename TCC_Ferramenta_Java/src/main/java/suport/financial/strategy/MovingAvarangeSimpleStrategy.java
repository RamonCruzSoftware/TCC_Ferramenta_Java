	...
	public String makeOrder() {
		...
		try {
			if (mmsAValues.size() >= 5 && mmsBValues.size() >= 5) {
				...
				if (mmsBValues.get(index_0) > 0 && mmsAValues.get(index_0) > 0
						&& mmsAValues.size() > 1) {
					if ((mmsAValues.get(index_0) < mmsBValues.get(index_0))
							&& mmsAValues.get(index_1) > mmsBValues
									.get(index_1))
						order = "Buy";
					if ((mmsAValues.get(index_0) > mmsBValues.get(index_0))
							&& mmsAValues.get(index_1) < mmsBValues
									.get(index_1))
						order = "Sell";
					if (((mmsAValues.get(index_0) < mmsBValues.get(index_0)) && (mmsAValues
							.get(index_1)) < mmsBValues.get(index_1))
							|| ((mmsAValues.get(index_0) > mmsBValues
									.get(index_0)) && (mmsAValues.get(index_1) > mmsBValues
									.get(index_1)))) {
						order = "nothing";
					}
				}
