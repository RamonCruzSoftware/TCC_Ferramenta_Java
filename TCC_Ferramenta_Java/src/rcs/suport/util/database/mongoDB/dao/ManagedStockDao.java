			...
			if(managedStockStored!=null)
			{
				...
				}else
				{
					...
					managedStockToStore=new BasicDBObject("codeName",managedStockStored.getString("codeName"))
											...
											.append("profitPercent", managedStockStored.getDouble("profitPercent"))
											.append("profitValue", managedStockStored.getDouble("profitValue"))
											.append("candleSticks", candlSticksToStore)
											.append("buyed", (BasicDBObject) managedStockStored.get("buyed"))
											.append("selled", (BasicDBObject) managedStockStored.get("selled"))
											.append("qtdStocksBought", managedStockStored.getInt("qtdStocksBought"));
