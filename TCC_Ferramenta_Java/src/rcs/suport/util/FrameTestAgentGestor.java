...
import rcs.core.agents.Manager;


public class FrameTestAgentGestor  extends JFrame{
    ...
    protected rcs.core.agents.Manager m_owner;
    
    public FrameTestAgentGestor(rcs.core.agents.Manager owner)
    {
    	try{
    		jbInit();
    	}catch (Exception e)
    ...
    private void jbInit() throws Exception{
        ...
        lbl_guestCount.setText("1");
        slide_numGuests.setValue(1);
        ...
        //Setup the UI, which means creating and showing the mais frame
    ...
    void btn_start_actionPerformed(ActionEvent e) {
        ...
        m_owner.addBehaviour( new OneShotBehaviour() {
                                 ...
                                 //     ((HostAgent) myAgent).inviteGuests( slide_numGuests.getValue() );
                                	  ((Manager)myAgent).createExpertAgents(1000,"Expert");
                                  }
                              } );
        m_owner.addBehaviour(new OneShotBehaviour() {
			...
			@Override
			public void action() {
			//	((HostAgent)myAgent).beginConversation();				
			}
		});
    }
        ...
        m_owner.addBehaviour( new OneShotBehaviour() {
                                  public void action() {
                                   //   ((HostAgent) myAgent).endParty();
                                	  ((Manager)myAgent).dropExpertAgent("Expert");
                                  }
                              } );
    }
    ...
    void btn_Exit_actionPerformed(ActionEvent e) {
        m_owner.addBehaviour( new OneShotBehaviour() {
                                  public void action() {
                                    //  ((rcs.core.agents.Gestor) myAgent).terminateHost();
                                  }
                              } );
    }
